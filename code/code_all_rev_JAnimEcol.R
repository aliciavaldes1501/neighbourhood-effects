...
summary(glm.nb(n_eggs_max~scale(Mrub_rug_s), subset(data_plants_paper,!is.na(phen)&n_eggs_max>0))) #NS
summary(glm.nb(n_eggs_max~scale(Mrub_sch_rug_s), subset(data_plants_paper,!is.na(phen)&n_eggs_max>0))) #NS

summary(glm.nb(n_eggs_max~scale(allM_pres), subset(data_plants_paper,!is.na(phen)&n_eggs_max>0))) #0.07347
summary(glm.nb(n_eggs_max~scale(Mrub_pres), subset(data_plants_paper,!is.na(phen)&n_eggs_max>0))) #0.08621
summary(glm.nb(n_eggs_max~scale(Msca_pres), subset(data_plants_paper,!is.na(phen)&n_eggs_max>0))) #-0.15979
...
summary(glm.nb(n_eggs_max~scale(Mrub_rug_pres), subset(data_plants_paper,!is.na(phen)&n_eggs_max>0))) #0.09532
summary(glm.nb(n_eggs_max~scale(Mrub_sch_pres), subset(data_plants_paper,!is.na(phen)&n_eggs_max>0))) #0.09290
summary(glm.nb(n_eggs_max~scale(Mrub_sch_rug_pres), subset(data_plants_paper,!is.na(phen)&n_eggs_max>0))) #0.13194
